...
$(function(){
  $(".typed-effect").typed({
    strings: ["I'm Mohammed Ali Farman"], // ^{number} denotes time in ms to wait
  ...
  setTimeout ( function() {
    $(".testing-typed").typed({
    strings: ["I'm a Front-end Developer and want to make things that make difference"], // ^{number} denotes time in ms to wait
